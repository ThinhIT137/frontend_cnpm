...
export function BookingHotelForm({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res && res.success) {
                alert(
                    "🎉 Đặt phòng thành công! Đang chờ chủ Khách Sạn xác nhận.",
                );
                onClose();
            } else {
            ...
            alert("❌ Lỗi mạng hoặc phiên đăng nhập hết hạn!");
        } finally {
                ...
                >
                    <div className="bg-sky-50 p-4 rounded-2xl border border-sky-100 flex flex-col gap-3">
                        ...
                        <input
                            ...
                            placeholder="Địa chỉ rước khách (Sân bay/Khách sạn)"
                            className="w-full p-3 rounded-xl border text-black border-white focus:ring-2 focus:ring-sky-300 outline-none text-sm font-medium"
                        />
                        <textarea
                            rows={2}
                    ...
                    <div className="flex flex-col gap-2 mt-auto">
                        ...
                        <button
                            ...
                            className="w-full mt-4 py-4 bg-sky-600 text-white font-black text-lg rounded-xl hover:bg-sky-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {isSubmitting
                                ? "⏳ ĐANG XỬ LÝ..."
                                : "XÁC NHẬN ĐẶT PHÒNG"}
